...
public class Repository {
	...
	public void ProcessLine(String inputLine) {
		...
		if (InstructionString != null) {
			...
			MIPSsim.OutputBuffer.add(OutputString + InstructionString + "\n");
			
			MIPSsim.MainMemory.put(Address, InstructionString);
			InstructionInfo info = new InstructionInfo();
			info.setAddress(Address);
			info.setInstruction(InstructionString);
			info.setStage("IF");
			MIPSsim.InstructionMap.put(Address, info);
			MIPSsim.Instructions.add(InstructionString);
			MIPSsim.Addresses.add(Address);
			
		} else {
			
			MIPSsim.OutputBuffer.add(OutputString + "\n");
			
			if (BreakIssued) {
				
				MIPSsim.MainMemory.put(Address, Long.toString(data));
